...
| [3. MCP Toolbox for databases - custom MCP server](scenarios/3.%20MCP%20Toolbox%20for%20databases%20-%20custom%20MCP%20server/README.md) | <ul><li><b>Run MCP Toolbox for Databases as a easy YAML-configured MCP server</b></li></ul> |
...
| Keycloak (Identity/OAuth) | [http://localhost:8081](http://localhost:8081)                   | -                                                      | Keycloak IAM; `mcp-2lo` realm — ADK caller, MCP servers as audiences |
